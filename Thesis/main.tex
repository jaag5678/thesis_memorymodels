...
\author{\textcopyright Akshay Gopalakrishnan, 2021}
\date{}
...
\begin{titlepage}
    \begin{center}
        ...
        \copyright\hspace{0.5mm}2021 Akshay Gopalakrishnan
...
\clearpage
 \pagenumbering{arabic} % restart page numbers at one, now in arabic style
    ...
    \input{3.ECMAScriptMemoryModel/main.tex}

    %Instruction reordering
    \chapter{Instruction Reordering}
    \input{4.InstructionReordering/main.tex}

    %Elimination
    \chapter{Elimination} 
    \input{5.Elimination/main.tex}

    \chapter{Conclusion, Summary, Future Work}
    \input{6.ConclusionFutureWork/main.tex}
    ...
    \input{7.CounterExamples/main.tex}
