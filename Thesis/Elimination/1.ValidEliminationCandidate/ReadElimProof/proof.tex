\begin{proof}
    ...
    \input{Elimination/1.ValidEliminationCandidate/ReadElimProof/ProofParts/part1.tex}

    \input{Elimination/1.ValidEliminationCandidate/ReadElimProof/ProofParts/part2.tex}
    
    \input{Elimination/1.ValidEliminationCandidate/ReadElimProof/ProofParts/part3.tex}

    \input{Elimination/1.ValidEliminationCandidate/ReadElimProof/ProofParts/part4.tex}
