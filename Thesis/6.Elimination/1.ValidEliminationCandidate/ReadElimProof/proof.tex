\begin{proof}
    ...
    \input{6.Elimination/1.ValidEliminationCandidate/ReadElimProof/ProofParts/part1.tex}

    \input{6.Elimination/1.ValidEliminationCandidate/ReadElimProof/ProofParts/part2.tex}
    
    \input{6.Elimination/1.ValidEliminationCandidate/ReadElimProof/ProofParts/part3.tex}

    \input{6.Elimination/1.ValidEliminationCandidate/ReadElimProof/ProofParts/part4.tex}
