\section{Summary of Our Approach}
    ...
    Hence, generalizations by using a small examples is not something we can afford especially when we want to ensure these program trasnformations are done by the compiler in contrast to being done manually.
    ...
    What implications this change has on the Observable Behaviors depends on the type of events $e$ and $d$ are and would require an analysis on each Candidate Execution. 
