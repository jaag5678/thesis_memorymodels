\begin{proof}
    ...
    \input{5.InstructionReordering/4.ValidReorderingCandidate/ProofParts/Part1/part1.tex}
    \input{5.InstructionReordering/4.ValidReorderingCandidate/ProofParts/Part2/part2.tex}
    \input{5.InstructionReordering/4.ValidReorderingCandidate/ProofParts/Part3/part3.tex}
    \input{5.InstructionReordering/4.ValidReorderingCandidate/ProofParts/Part4/part4.tex}
