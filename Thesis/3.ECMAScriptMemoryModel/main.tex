...
\input{3.ECMAScriptMemoryModel/0.Intro.tex}

\input{3.ECMAScriptMemoryModel/1.Agents.tex}

\input{3.ECMAScriptMemoryModel/2.Event_Sets.tex}

\input{3.ECMAScriptMemoryModel/3.Event_Relations.tex}

\input{3.ECMAScriptMemoryModel/4.Ordering_Relations_On_Events.tex}

\input{3.ECMAScriptMemoryModel/5.PreliminaryDefinitions.tex}

\input{3.ECMAScriptMemoryModel/6.Valid_Execution_Rules.tex}

\input{3.ECMAScriptMemoryModel/7.Race.tex}

\input{3.ECMAScriptMemoryModel/8.Valid_Execution.tex}
