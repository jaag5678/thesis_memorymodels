\section{Preliminaries}
    ...
    \begin{definition}{Candidate Execution}
        ...
        \begin{figure}[H]
            \centering
            \includegraphics[scale=0.7]{ECMAScriptMemoryModel/CandidateExecution.pdf}
    ...
    \begin{definition}{Obs}
        ...
        \critic{blue}{Consider whether it is required to define $Obs_O$, since it is a redundant defintion, as it maps every observablke behavior to a singleton set with that observable behavior.}
    \end{definition}

    \critic{red}{The last definition would call for quite some edits in the proofs ahead. Need to spend separate dedicated time to get them done. Plan this carefully and only after adding all necessary figures where required for each part of the proof.}
%-----------------------------------------------------------------------------------------------------------------------------------------
