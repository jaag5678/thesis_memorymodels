...
\input{ECMAScriptMemoryModel/prologue.tex}
...
\paragraph{The Model is Quite Algorithmic}
    ...
    \begin{figure}[H]
        \centering 
        \includegraphics[scale=0.6]{ECMAScriptMemoryModel/ECMAScriptStdCoherentReads.pdf}
...
\paragraph{Certain Unnecessary Definitions}
    ...
    \begin{figure}[H]
        \centering 
        \includegraphics[scale=0.6]{ECMAScriptMemoryModel/ECMAScriptStd.pdf}
